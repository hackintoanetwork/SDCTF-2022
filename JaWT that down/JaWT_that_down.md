...
<b>우선 로그인 버튼을 눌러 아래 페이지로 들어갔다.</br></b>
...
<b>아이디 비밀번호는 페이지 소스에서 주석으로 알려주고 있었다.</br></b>
...
<b>페이지 소스코드 주석에서 알려준 아이디로 로그인을 하니 Flag 버튼이 생겼다.</br></b>
...
<b>Flag 버튼을 눌렀더니 "Inavalid Token: Access Denied" 라는 문구만 나오고 Flag는 나오지 않았다.</br></b>
When I pressed the Flag button, the phrase "Invalid Token: Access Denied" came out, and Flag didn't come out.</br>

---

<b>"Inavalid Token: Access Denied" 문구를 통해서 Token을 활용해 푸는 문제라는 걸 대략 짐작할 수 있었고
바로 EditThisCookie로 Token 값을 확인해보았다.</br></b>
...
<b>긴 Token 값을 [.] 기준으로 아래와 같이 세 문단으로 나누어 보았다.</br></b>
...
<b>그리고 Base64로 인코딩 되어 있는 것 같아 디코딩도 시도해보았다.</br></b>
...
<b>첫번째 문단과 두번째 문단은 디코딩이 되었다.</br></b>
The first paragraph and the second paragraph were decoded.</br>

<b>하지만 세번째 문단은 디코딩이 되지 않았다.</br></b>
...
<b>디코딩 된 최종 값은 위와 같다.</br></b>
The decoded final value is as above.</br>

<b>첫번째 문단이 디코딩 된 값에 "JWT" 라 적혀 있어 구글에 검색해 보았고 JSON 웹 토큰이라는 것을 알 수 있었다.</br>
...
<b>jwt.io에선 JWT 웹 토큰 구조를 더 잘 파악할 수 있다.</br></b>
...
<b>토큰이 만료 되기 전 재빠르게 Flag 버튼을 눌러 들어갔고 "d"라는 문자가 출력된 것을 보았다.</br></b>
...
<b>이렇게 파이썬 자동화 스크립트를 통해 간편하게 문제를 풀 수 있었다.</br></b>
